...
<body>
    <nav style="width: 100%; justify-content: center; background: #f0f0f0; padding: 10px 0; box-sizing: border-box; display: flex; gap: 20px;">
        <a href="?page=cadastrar" style="text-decoration: none; color: #333; font-weight: bold;">Cadastrar novo jogo</a>
        <a href="?page=listar" style="text-decoration: none; color: #333; font-weight: bold;">Listar jogos</a>
    </nav>
    <div id="container" style="height: calc(98vh - 50px); overflow-y: auto; padding: 20px; box-sizing: border-box;">
        <?php
            if (isset($_GET['page']) && $_GET['page'] === 'cadastrar') {
                require_once __DIR__ . '/pages/jogo_cadastrar.php';
            } 
            elseif (isset($_GET['page']) && $_GET['page'] === 'editar') {
                require_once __DIR__ . '/pages/jogo_editar.php';
            }
            elseif (isset($_GET['page']) && $_GET['page'] === 'deletar') {
                require_once __DIR__ . '/pages/jogo_deletar.php';
            }
            else {
                require_once __DIR__ . '/pages/jogo_listar.php';
